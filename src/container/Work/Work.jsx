    ...
    return (
        <div className="app__container mt-[7rem]">
            <h2 className="head-text">
                {title.text1} <span className="text-purple-400">{title.text2}</span>
            </h2>
            ...
            <div className="mt-16 flex flex-row flex-wrap items-center justify-center">
                {btnTitles.map((item, index) => (
                    <div
                        ...
                        className={`m-2 flex cursor-pointer flex-row rounded-md px-6 py-3 font-bold transition-all hover:bg-CustomBlack/70 hover:text-white ${activeFilter === item
