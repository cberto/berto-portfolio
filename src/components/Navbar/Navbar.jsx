...
const Navbar = ({ setLanguage }) => {
    ...
    return (
        <>
            {!toggle && (
                <nav
                    className={`fixed z-20 w-full overflow-hidden bg-transparent px-4 py-5 text-white backdrop-blur-sm ${scroll ? 'bg-CustomBlack/75' : ''
                        }`}
                >
                    <div className="container mx-auto flex items-center justify-between">
                        ...
                        <ul className="absolute top-1/2 left-1/2 hidden -translate-y-1/2 -translate-x-1/2 transform gap-x-4 md:mx-auto md:flex md:w-auto md:items-center lg:gap-x-6 text-transform: uppercase">
